import { l as ServerInstrumentation, H as HydrationState, f as StaticHandlerContext, c as RelativeRoutingType, a as Router$1, d as RouterState, R as RouterInit, t as FutureConfig$1, C as ClientInstrumentation, e as GetScrollRestorationKeyFunction, F as Fetcher, B as BlockerFunction, u as CreateStaticHandlerOptions$1, S as StaticHandler } from './instrumentation-wPsSsHH2.js';
import * as React from 'react';
import { aD as RouteManifest, aE as ServerRouteModule, s as MiddlewareEnabled, c as RouterContextProvider, t as AppLoadContext, r as LoaderFunctionArgs, $ as ActionFunctionArgs, K as RouteModules, n as DataRouteObject, a as ClientLoaderFunction, aF as TrackedPromise, f as History, T as To, L as Location, i as Action, ab as RouteMatch, X as InitialEntry, Z as NonIndexRouteObject, a6 as LazyRouteFunction, Y as IndexRouteObject, P as Params, l as DataStrategyFunction, m as PatchRoutesOnNavigationFunction, e as RouteObject, U as UIMatch, o as HTMLFormMethod, F as FormEncType, au as PageLinkDescriptor, O as SerializeFrom } from './data-D_VDPZeC.js';
